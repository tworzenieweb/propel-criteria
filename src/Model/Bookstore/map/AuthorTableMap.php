...
class AuthorTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Tworzenieweb\\Model\\Bookstore\\Author');
    ...
    {
        $this->addRelation('Book', 'Tworzenieweb\\Model\\Bookstore\\Book', RelationMap::ONE_TO_MANY, array('id' => 'author_id', ), null, null, 'Books');
    } // buildRelations()
