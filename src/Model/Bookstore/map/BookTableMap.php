...
namespace Tworzenieweb\Model\Bookstore\map;
...
class BookTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setClassname('Tworzenieweb\\Model\\Bookstore\\Book');
    ...
    {
        $this->addRelation('Publisher', 'Tworzenieweb\\Model\\Bookstore\\Publisher', RelationMap::MANY_TO_ONE, array('publisher_id' => 'id', ), null, null);
        $this->addRelation('Author', 'Tworzenieweb\\Model\\Bookstore\\Author', RelationMap::MANY_TO_ONE, array('author_id' => 'id', ), null, null);
    } // buildRelations()
