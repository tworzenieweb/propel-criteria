...
use Tworzenieweb\Model\Bookstore\map\PublisherTableMap;
...
abstract class BasePublisherPeer
{
    ...
    const OM_CLASS = 'Tworzenieweb\\Model\\Bookstore\\Publisher';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Tworzenieweb\\Model\\Bookstore\\map\\PublisherTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePublisherPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Tworzenieweb\Model\Bookstore\map\PublisherTableMap());
      }
    }
