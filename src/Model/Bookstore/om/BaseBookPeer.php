...
use Tworzenieweb\Model\Bookstore\map\BookTableMap;
...
abstract class BaseBookPeer
{
    ...
    const OM_CLASS = 'Tworzenieweb\\Model\\Bookstore\\Book';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Tworzenieweb\\Model\\Bookstore\\map\\BookTableMap';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseBookPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Tworzenieweb\Model\Bookstore\map\BookTableMap());
      }
    }
