...
use Tworzenieweb\Model\Bookstore\PublisherPeer;
use Tworzenieweb\Model\Bookstore\PublisherQuery;
...
abstract class BasePublisherQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'Tworzenieweb\\Model\\Bookstore\\Publisher';
        }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Tworzenieweb\Model\Bookstore\BookQuery A secondary query class using the current class as primary query
     */
    public function useBookQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book', '\Tworzenieweb\Model\Bookstore\BookQuery');
    }
